...
- `mentions-legales.html` : contient des champs `[à compléter]` (SIRET, forme juridique, adresse) — **à remplir avant mise en ligne**, obligation légale pour un site professionnel en France.
